...
function RootLayoutNav() {
  ...
  const miniPlayerBottom = isTabsRoute
    ? (Platform.OS === 'web' ? 90 : (insets.bottom + 54))
    : (insets.bottom + 8);
  ...
  return (
    <>
      ...
      <Stack screenOptions={{ headerBackTitle: "Back", contentStyle: { backgroundColor: '#0A0A0A' } }}>
        ...
        <Stack.Screen name="queue" options={{ headerShown: false, presentation: 'modal', contentStyle: { backgroundColor: '#0A0A0A' } }} />
